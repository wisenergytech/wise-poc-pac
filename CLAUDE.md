...
- R 4.5+ (Shiny) + golem, R6, shiny, bslib, dplyr, lubridate, plotly (existants — aucune nouvelle dépendance) (006-dual-csv-import)
- N/A (fichiers CSV uploadés en mémoire, pas de persistance) (006-dual-csv-import)
