...
mod_co2_ui <- function(id) {
  ...
  shiny::tagList(
    ...
    bslib::card(full_screen = TRUE,
      ...
      bslib::card_body(fillable = TRUE, plotly::plotlyOutput(ns("plot_co2_emissions"), height = "100%"), min_height = "350px")),
    bslib::layout_columns(col_widths = c(6, 6),
      bslib::card(full_screen = TRUE,
        ...
        bslib::card_body(fillable = TRUE, plotly::plotlyOutput(ns("plot_co2_cumul"), height = "100%"), min_height = "300px")),
      bslib::card(full_screen = TRUE,
        ...
        bslib::card_body(fillable = TRUE, plotly::plotlyOutput(ns("plot_co2_heatmap"), height = "100%"), min_height = "300px"))),
